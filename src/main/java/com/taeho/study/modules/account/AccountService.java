...
import com.taeho.study.modules.account.form.Notifications;
import com.taeho.study.modules.account.form.Profile;
...
public class AccountService implements UserDetailsService {
    ...
    public void sendSignUpConfirmEmail(Account newAccount) {
        ...
        context.setVariable("message", "Study 서비스를 사용하려면 링크를 클릭하세요.");
