...
import com.taeho.study.modules.event.form.EventForm;
import com.taeho.study.modules.event.validator.EventValidator;
import com.taeho.study.modules.study.StudyService;
...
public class EventController {
    ...
    public String updateEventSubmit(@CurrentAccount Account account,
                                  @PathVariable String path, @PathVariable("id") Event event, @Valid EventForm eventForm, Errors errors,
                                    Model model){
        Study study = studyService.getStudyToUpdate(account, path);
    ...
    public String cancelEvent(@CurrentAccount Account account, @PathVariable String path, @PathVariable("id") Event event) {
        Study study = studyService.getStudyToUpdateStatus(account, path);
        eventService.deleveEvent(event);
