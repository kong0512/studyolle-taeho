...
import com.taeho.study.modules.study.form.StudyDescriptionForm;
...
public class StudySettingsController {
    ...
    public String viewStudyString(@CurrentAccount Account account, @PathVariable String path, Model model){
    ...
    public String viewStudyString(@CurrentAccount Account account, @PathVariable String path,
